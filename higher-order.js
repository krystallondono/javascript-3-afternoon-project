...
let bobsTotal = purchases.filter((el) => {
    el.owner === 'Bob';
    // bobsTotal.reduce((curr, acc) => {
    //   return curr.price + acc.price;})

  })

  // let bobsTotal = hereIsBob.reduce((curr, acc) => {
  //   return curr.price + acc.price;
  // });

// let bobsTotal2 = bobsTotal.reduce((acc, curr) =>{
//   return acc + curr.price;
// })

// bobsTotal = bobsTotal2;
